<?php
class Ext_Form_Default_Development_SampleZendFormMultipleSubforms extends Zend_Form
{
...
//            ;
        ...
        $subform->setLegend('Subform 1 legend');
        
        $subform2 = new Zend_Form_SubForm();
        $subform2->setLegend('Subform 2 legend');
...
//          $commentsAvailability,
        ...
        $this->addSubForm($subform2, 'configStaticPage2', 0);
