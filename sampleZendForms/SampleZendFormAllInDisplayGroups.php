<?php
class Ext_Form_Default_Development_SampleZendFormAllInDisplayGroups extends Zend_Form
{
...
//          $commentsAvailability,
        ...
        $subform->addDisplayGroup(
            array('publication_date', 'might_be_link', 'tags_enabled'),
            'group-optional-fields',
            'might_be_link',
            'tags_enabled'
            
        );
        $groupChildren = $subform->getDisplayGroup('group-optional-fields');
        $groupChildren->setLegend('optionalFields');
        
        $subform->addDisplayGroup(
            array('description', 'layout_view', 'might_be_link', 'deleteable'),
            'group-settings'
        );
        $groupChildren = $subform->getDisplayGroup('group-settings');
        $groupChildren->setLegend('settings');
